...
export default [
  ...
  [COLOR_REGEXPS.divide, ([_]) => emitWarning(_, TYPES.replaced, COLOR_MESSAGES.divide)],
  [/^divide-(transparent|none|dotted|solid|double|dashed)$/, ([_]) => emitWarning(_, TYPES.removed)],
